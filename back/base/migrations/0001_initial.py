    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tatamis_count', models.IntegerField(blank=True, default=0, max_length=2)),
                ...
                ('logos', models.ManyToManyField(blank=True, default=[], to='base.logos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(choices=[('Админ ', 'Админ'), ('Секретарь ', 'Секретарь'), ('Свободный', 'Свободный')], on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Participant',
